...
export const BentoGridItem = ({
  ...
  const rightLists = ["MongoDB", "PostreSQL", "GraphQL"];
  ...
  const handleCopy = () => {
    const text = "rohithc.eec.cseb@gmail.com";
  ...
  return (
    <div
      className={cn(
        ...
        "text-white row-span-1 relative overflow-hidden rounded-3xl border border-white/[0.1] group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none justify-between flex flex-col space-y-4",
        className
      )}
      style={{
        //   add these two
